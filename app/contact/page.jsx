  ...
  return (
    ...
    >
      <div className="container mx-auto">
        {/* Parent container with flex direction change */}
        <div className="flex flex-col-reverse xl:flex-row gap-[30px]">
          {/* Info section - Comes first on small/medium, second on xl */}
          ...
          {/* Form section - Comes second on small/medium, first on xl */}
          <div className="xl:h-[54%] order-2 xl:order-1">
            ...
            >
              ...
              <p className="text-white/60">
                ...
                illum doloremque ex ea accusamus totam!
              </p>
